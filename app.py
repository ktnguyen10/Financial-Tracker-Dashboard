...
server.register_blueprint(flask_app, url_prefix="/main")
server.register_blueprint(dash_app, url_prefix="/main")
conn = init_database()
...
def render_dashboard():
    dash_layout, register_callbacks = financial_dashboard()
    create_dash_app(server, curs, session["user_id"], dash_layout, register_callbacks)
